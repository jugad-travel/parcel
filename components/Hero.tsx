...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-4 pb-20">
      ...
      >
        <Image
          src="/images/parcel sans fond .png"
          alt="Parcel"
          width={600}
          height={240}
      ...
      >
        ...
        <div className="flex justify-center pt-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <p className="text-xl md:text-2xl text-white/90 max-w-2xl animate-fade-in-up drop-shadow-md text-left pl-8" style={{ width: 'fit-content' }}>
            <RotatingWords />
          </p>
        </div>
